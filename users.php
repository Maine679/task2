                    ...
                    <div id="c_<? echo $item['id'] ?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<? echo $item['name'] . ' ' . $item['surname']; ?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    <? if($user['id'] == $item['id'] || $user['user_status'] == 'admin'): ?>
                                            ...
                                            <a class="dropdown-item" href="edit.php?id=<? echo $item['id'] ?>">
                                                <i class="fa fa-edit"></i>
                                            Редактировать</a>
                                            <a class="dropdown-item" href="security.php?id=<? echo $item['id'] ?>">
                                                <i class="fa fa-lock"></i>
                                            Безопасность</a>
                                            <a class="dropdown-item" href="status.php?id=<? echo $item['id'] ?>">
                                                <i class="fa fa-sun"></i>
                                            Установить статус</a>
                                            <a class="dropdown-item" href="media.php?id=<? echo $item['id'] ?>">
                                                <i class="fa fa-camera"></i>
                                                Загрузить аватар
                                            </a>
                                            <a href="action/action_delete.php?id=<? echo $item['id']; ?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                                ...
                                <button class="js-expand-btn btn btn-sm btn-default d-none" data-toggle="collapse" data-target="#c_<? echo $item['id'] ?> > .card-body + .card-body" aria-expanded="false">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<? echo $item['phone']; ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i><? echo $item['phone']; ?></a>
